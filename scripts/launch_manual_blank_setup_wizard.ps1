...
if (-not $ExePath) {
    $ExePath = Join-Path $root "dist_test\phase-6b-full-gui-maskpreviewfix-20260512\reconstruction_zone.dist\ReconstructionZone.exe"
}
...
9. Test Extract, then Mask Preview, then one actual Mask operation.
